<div class="card text-center">
    ...
    <div class="card text-center">
        ...
        $no = 1;
        $query = "SELECT * FROM vw_kamar_melati ORDER BY nomorLantai ASC";
            ...
            ?>
                <div id="result">
                    <tr>
                        ...
                        <td>
                            <button type="button" id="idBtn_orderMelati" class="btn btn-success" value="<?php echo $hasil['id_kamar']; ?>" title="Edit" name="button">
