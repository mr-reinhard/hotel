...
$assocMenunggu = mysqli_fetch_assoc($runMenunggu);
$rowMenunggu = $assocMenunggu['verify'];
?>
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-xl-3">
            <div class="card bg-c-yellow order-card">
                <div class="card-block">
                    <h6 class="m-b-20">Verifikasi</h6>
                    <h2 class="text-right"><i class="fa-solid fa-circle-question"></i><span class="ms-5"><?php echo $rowMenunggu ?></span></h2>
                    <!-- <p class="m-b-0">Completed Orders<span class="f-right">351</span></p> -->
                </div>
            </div>
        </div>
